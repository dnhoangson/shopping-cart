        ...
        <ul class="navbar-nav ml-right">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <?php if(Auth::check()): ?>
                    <a class="dropdown-item" href="<?php echo e(route('user.profile')); ?>">User Profile</a>
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('user.signin')); ?>">Login</a>
                    <?php endif; ?>
                </div>
            </li>
        </ul>
    </div>
</nav><?php /**PATH D:\XAMPP\htdocs\shopping-cart\resources\views/partials/header.blade.php ENDPATH**/ ?>